...
public:
    ...
    virtual void disable_pitch_control() { return; } 
    ...
    virtual void input_euler_rate_yaw_euler_angle_pitch_bf_roll(bool plane_controls, float euler_roll_angle_cd, 
        float euler_pitch_angle_cd, float euler_yaw_rate_cds, bool wing_deploy, uint32_t tsld, bool in_projectile_flight = false, bool launch_mode = false) {}
    ...
    virtual void rate_controller_run(int32_t target_pitch_angle = 0, bool wing_deploy = true, uint32_t tsld = 1000, bool launch_mode = false) = 0;
...
protected:
    ...
    Vector3f update_ang_vel_target_from_att_error(const Vector3f &attitude_error_rot_vec_rad, const int32_t pitch_cd_cmd = 0, bool wing_deploy = true, uint32_t tsld = 1000, bool lm = false);
