...
void AC_AttitudeControl_Multi_6DoF::rate_controller_run(int32_t target_pitch_angle, bool wing_deploy, uint32_t tsld, bool launch_mode) {
...
void AC_AttitudeControl_Multi_6DoF::input_euler_rate_yaw_euler_angle_pitch_bf_roll(bool plane_controls, float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_rate_cds, bool wing_deploy, uint32_t tsld, bool in_projectile_flight, bool launch_mode) {
    _motors.set_lateral(0.0f);
    _motors.set_forward(0.0f);

    AC_AttitudeControl_Multi::input_euler_rate_yaw_euler_angle_pitch_bf_roll(plane_controls, euler_roll_angle_cd, euler_pitch_angle_cd, euler_yaw_rate_cds, wing_deploy, tsld, in_projectile_flight, launch_mode);
}
